function result = educationalFarfieldPatternMetadata(thetaValues, phiValues, options)
%EDUCATIONALFARFIELDPATTERNMETADATA Check far-field table metadata first.
%
...
result = struct();
result.kind = "educational_farfield_pattern_metadata";
