function report = meshImportQualityManifest(surfaceElementTypes, volumeElementTypes, varargin)
%meshImportQualityManifest Readable mesh handoff preflight.
%
...
p = inputParser;
p.FunctionName = "meshImportQualityManifest";
...
report = struct();
report.kind = "mesh_import_quality_manifest";
