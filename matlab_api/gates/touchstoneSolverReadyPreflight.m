function result = touchstoneSolverReadyPreflight(s11, s21, options)
...
equivalent = touchstoneEquivalentCircuit(s11, s21, ...
    "S12", s12, ...
    "S22", s22, ...
    "Z0", options.Z0, ...
    "Tolerance", options.Tolerance);
match = touchstonePortMatch(s11, ...
...
result = struct();
result.kind = "touchstone_solver_ready_preflight";
...
switch lower(strtrim(unit))
    ...
    case "ghz"
        scale = 1e9;
    otherwise
        error("touchstoneSolverReadyPreflight:frequencyUnit", ...
