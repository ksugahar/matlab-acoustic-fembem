function result = educationalFarfieldGainDirectivityEfficiency(gainDbi, directivityDbi, options)
%EDUCATIONALFARFIELDGAINDIRECTIVITYEFFICIENCY Check G = eta_rad * D.
%
...
result = struct();
result.kind = "educational_farfield_gain_directivity_efficiency";
...
result.notes = [
    "run educationalFarfieldPatternMetadata before this numeric row gate"
