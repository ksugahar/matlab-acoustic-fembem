function corner = educationalFemBemLcurveCorner(model, target, alphas, options)
%EDUCATIONALFEMBEMLCURVECORNER Pick a readable Tikhonov L-curve corner.
%
% The path is computed by educationalFemBemTikhonovPath.  This helper adds
...
if numel(alphaValues) < 3
    error("educationalFemBemLcurveCorner:alphas", ...
...
corner = struct();
corner.kind = "educational_fem_bem_lcurve_corner";
