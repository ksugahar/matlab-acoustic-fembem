function result = educationalMqCoulombGaugePostprocessPackage(artifacts, options)
%EDUCATIONALMQCOULOMBGAUGEPOSTPROCESSPACKAGE Bundle MQS E-field postprocess gates.
%
...
result = struct();
result.kind = "educational_mqs_coulomb_gauge_efield_postprocess_package";
