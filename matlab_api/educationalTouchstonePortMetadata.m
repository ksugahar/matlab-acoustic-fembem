function result = educationalTouchstonePortMetadata(ports, options)
%EDUCATIONALTOUCHSTONEPORTMETADATA Check Touchstone table metadata before rows.
%
...
result = struct();
result.kind = "educational_touchstone_port_metadata";
