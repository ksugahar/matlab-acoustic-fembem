function report = helmholtzKernelManifest(targetPoint, sourcePoint, options)
%HELMHOLTZKERNELMANIFEST Manifest gate for low-frequency BEM kernels.
%
...
base = lowFrequencyHelmholtzReport(targetPoint, sourcePoint, ...
