function report = educationalFemBemNormalFluxSignReport(model, gradientVector, options)
%EDUCATIONALFEMBEMNORMALFLUXSIGNREPORT Check .vol outward-normal flux signs.
%
...
rows = model.trace.orientationRows;
signs = double(model.trace.triangleOrientationSignsToOutward(:));
nRows = numel(rows);
