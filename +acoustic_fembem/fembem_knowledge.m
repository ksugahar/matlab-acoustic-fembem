...
s = strjoin([
    ...
    ""
    "Generic display writer:"
    "  writeGmshPostLaunchArtifact(""case.msh"", ""Views"", views, ...)"
    "  creates the same case.geo + case.geo.opt + case.msh.opt contract for"
    "  any readable MATLAB/Gypsilab result that already has MSH v4.1 data."
    "  It records the cut-plane normal/offset, a Z-up x-z camera preset or"
    "  explicit Rotation=[Rx Ry Rz], view names, time-step linking, scalar,"
    "  vector, and displacement views, and a display JSON sidecar.  Use this"
    "  for new drum, waveguide, microphone-sensitivity, and FEM/BEM teaching"
    "  scenes before writing another artifact-specific .opt routine."
    ""
    "Minimal path:"
