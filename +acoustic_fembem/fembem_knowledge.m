...
s = strjoin([
    ...
    "NGSolve export convention-free numbers (mapped Gauss points + Jacobian +"
    "normal, or isoparametric Lagrange nodes) and feed those to a"
    "CurvedPanelQuadrature-style adapter.  General curved high-order .vol stays"
    "Radia/NGSolve's job."
    ], newline);
end
