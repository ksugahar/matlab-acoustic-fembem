...
s = strjoin([
    ...
    "The higher-context scene shows a cylindrical drum frame, the membrane,"
    "and a spherical truncation surface labelled as the high-order impedance"
    "absorbing-boundary lane for Radia-style open-boundary experiments; it is"
    "not the Kelvin transform."
    ""
